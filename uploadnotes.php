...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['notes'])) {
    ...
    if (move_uploaded_file($file_tmp, $file_path)) {
        $sql = "INSERT INTO notes (username, department, semester, subject, file_path, file_type, file_size)
                VALUES ('$username', '$department', '$semester', '$subject', '$file_path', '$file_type', '$file_size')";
